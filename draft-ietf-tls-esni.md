...
Similarly, implementations may wish to prohibit cleartext OCSP traffic in the
absence of stapled OCSP responses. Failure to do so may lead to inadvertent
leakage of otherwise encrypted domain names.
