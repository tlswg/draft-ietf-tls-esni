...
If server accepted ESNI, it MUST add the "esni_nonce" extension
with the client's nonce to EncryptedExtensions.
...
otherwise abort the connection with an "illegal_parameter" alert. The client then proceeds
