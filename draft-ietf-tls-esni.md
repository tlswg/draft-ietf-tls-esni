...
If random configuration identifiers (see {{random-configs}}) are used,
...
known ECHConfig. See {{random-configs}}. Unless specified by the application
...
## Random Configuration Identifiers and Trial Decryption {#random-configs}
